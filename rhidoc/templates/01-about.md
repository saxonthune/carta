...
This is the `.rhidoc/` workspace for **{{title}}**. It contains structured specifications that bridge the gap between what the artifact intends to be and what the code actually does.
