...
export const softwareArchitecturePackage: SchemaPackageDefinition = {
  id: 'std-pkg-software-architecture',
  ...
  schemaRelationships: [
    ...
    { id: 'rel-rest-endpoint-to-database', sourceSchemaType: 'rest-endpoint', sourcePortId: 'flow-out', targetSchemaType: 'database', targetPortId: 'link-in', label: 'Connect to Database' },
    { id: 'rel-rest-endpoint-to-auth-policy', sourceSchemaType: 'rest-endpoint', sourcePortId: 'policy-in', targetSchemaType: 'auth-policy', targetPortId: 'flow-out', label: 'Add Auth Policy' },
    { id: 'rel-rest-endpoint-to-rate-limit', sourceSchemaType: 'rest-endpoint', sourcePortId: 'policy-in', targetSchemaType: 'rate-limit', targetPortId: 'flow-out', label: 'Add Rate Limit' },
    { id: 'rel-rest-endpoint-to-cache-policy', sourceSchemaType: 'rest-endpoint', sourcePortId: 'policy-in', targetSchemaType: 'cache-policy', targetPortId: 'flow-out', label: 'Apply Cache Policy' },
    // Database relationships
    { id: 'rel-database-to-table', sourceSchemaType: 'database', sourcePortId: 'child', targetSchemaType: 'table', targetPortId: 'parent', label: 'Add Table' },
    // Table relationships
    { id: 'rel-table-to-db-attribute', sourceSchemaType: 'table', sourcePortId: 'child', targetSchemaType: 'db-attribute', targetPortId: 'parent', label: 'Add Attribute' },
    { id: 'rel-table-to-constraint', sourceSchemaType: 'table', sourcePortId: 'child', targetSchemaType: 'constraint', targetPortId: 'parent', label: 'Add Constraint' },
    // API Model relationships
    { id: 'rel-api-model-to-rest-endpoint', sourceSchemaType: 'api-model', sourcePortId: 'child', targetSchemaType: 'rest-endpoint', targetPortId: 'parent', label: 'Add to Endpoint' },
    // UI relationships
    { id: 'rel-ui-event-to-ui-screen', sourceSchemaType: 'ui-event', sourcePortId: 'child', targetSchemaType: 'ui-screen', targetPortId: 'parent', label: 'Add to UI Screen' },
    { id: 'rel-ui-screen-to-user-story', sourceSchemaType: 'ui-screen', sourcePortId: 'flow-in', targetSchemaType: 'user-story', targetPortId: 'flow-out', label: 'Connect from User Story' },
    { id: 'rel-ui-screen-to-ui-event', sourceSchemaType: 'ui-screen', sourcePortId: 'parent', targetSchemaType: 'ui-event', targetPortId: 'child', label: 'Add Event' },
  ],
};
