...
export const bpmnPackage: SchemaPackageDefinition = {
  id: 'std-pkg-bpmn',
  name: 'BPMN',
  ...
  schemaRelationships: [
    ...
    { id: 'rel-bpmn-activity-to-gateway', sourceSchemaType: 'bpmn-activity', sourcePortId: 'seq-out', targetSchemaType: 'bpmn-gateway', targetPortId: 'seq-in', label: 'Add Gateway' },
    { id: 'rel-bpmn-activity-to-event', sourceSchemaType: 'bpmn-activity', sourcePortId: 'seq-out', targetSchemaType: 'bpmn-event', targetPortId: 'seq-in', label: 'Add Event' },
    { id: 'rel-bpmn-activity-to-data-object', sourceSchemaType: 'bpmn-activity', sourcePortId: 'data-link', targetSchemaType: 'bpmn-data-object', targetPortId: 'data-link', label: 'Add Data Object' },
    // Event relationships
    { id: 'rel-bpmn-event-to-activity', sourceSchemaType: 'bpmn-event', sourcePortId: 'seq-out', targetSchemaType: 'bpmn-activity', targetPortId: 'seq-in', label: 'Add Activity' },
    // Gateway relationships
    { id: 'rel-bpmn-gateway-to-activity', sourceSchemaType: 'bpmn-gateway', sourcePortId: 'seq-out', targetSchemaType: 'bpmn-activity', targetPortId: 'seq-in', label: 'Add Activity' },
    { id: 'rel-bpmn-gateway-to-event', sourceSchemaType: 'bpmn-gateway', sourcePortId: 'seq-out', targetSchemaType: 'bpmn-event', targetPortId: 'seq-in', label: 'Add End Event' },
    // Pool-Lane relationships
    { id: 'rel-bpmn-pool-to-lane', sourceSchemaType: 'bpmn-pool', sourcePortId: 'parent', targetSchemaType: 'bpmn-lane', targetPortId: 'child', label: 'Add Lane' },
    // Lane relationships
    { id: 'rel-bpmn-lane-to-activity', sourceSchemaType: 'bpmn-lane', sourcePortId: 'parent', targetSchemaType: 'bpmn-activity', targetPortId: 'child', label: 'Add Activity' },
    { id: 'rel-bpmn-lane-to-event', sourceSchemaType: 'bpmn-lane', sourcePortId: 'parent', targetSchemaType: 'bpmn-event', targetPortId: 'child', label: 'Add Event' },
  ],
};
