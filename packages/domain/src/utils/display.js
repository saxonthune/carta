 ...
 */
export function getDisplayName(data, schema) {
    if (schema) {
 ...
 */
export function getFieldsForTier(schema, tier) {
 ...
 */
export function getFieldsForSummary(schema) {
    return schema.fields
 ...
 */
export function semanticIdToLabel(semanticId) {
