...
Design details for the Carta Docs API (doc04.06.01). For product description and motivation, see doc04.06.01.
...
Scope: the Docs API owns the bundle as a structural unit. Kind-awareness and content interpretation of attachment files are reconciliation's concern (doc04.07).
...
Spec-code reconciliation — comparing specifications against source code, extracting code shapes, detecting drift — is a separate product concern (doc04.07). The Docs API does not parse source code or reason about spec-code alignment.
