...
**Out of scope**: Content interpretation, kind declarations, and reconciliation-level awareness of attachment types belong to the reconciliation layer (doc04.07), not to this concept.
