...
- **doc03.02.01 — Attachment**: Non-md artifacts that inherit a host doc's structural position through prefix co-location. Purpose: let supporting files (diagrams, data, etc.) travel with their spec through every workspace operation without frontmatter declaration.
