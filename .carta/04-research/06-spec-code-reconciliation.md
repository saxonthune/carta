...
deps: [doc01.01.02, doc01.01.05.01, doc04.05, doc02.04.09]
---
...
**Simon's nearly-decomposable systems** (doc04.05): Well-partitioned data are easier to manipulate and transform. One file per module means each piece can be diffed, updated, and reasoned about independently.
