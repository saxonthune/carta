...
deps: [doc01.05.02, doc01.05.08.03]
date: 2026-02-14
updated: 2026-02-16
---
...
- **Stale reads**: `reactFlow.getNodes()` returns stale data immediately after `reactFlow.setNodes()` in the same synchronous block (doc01.05.08.03). Requires passing "known positions" forward as parameters — a fragile workaround.
