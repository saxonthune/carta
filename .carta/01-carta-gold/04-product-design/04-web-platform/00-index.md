...
deps: [doc01.05.06.02, doc01.05.05, doc01.05.02]
---
...
Both flavors operate on the same workspace and the same spec files. Users can switch between them freely within a session. See doc01.03.04 and doc01.03.09 for details.
...
- Make implicit judgments about how specs should be arranged (see doc01.05.02, "Spec Agnosticism")
...
See doc01.03.09 for web platform architecture details.
