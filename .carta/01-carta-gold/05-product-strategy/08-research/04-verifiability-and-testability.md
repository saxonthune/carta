...
deps: [doc01.05.08.02, doc01.03.05]
date: 2026-02-15
---
...
Each module exports pure functions that take data and return results. Hooks call these functions and apply results to the adapter. Tests exercise functions directly without React or Yjs. See doc01.05.08.02 for the corresponding integration tests.
