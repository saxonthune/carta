...
- **Decisions already made** — those go in ADRs (doc01.05.08.04)
- **Feature specifications** — those go in doc01.05.02
...
- An ADR (doc01.05.08.04) once a decision crystallizes
- A feature spec (doc01.05.02) once the feature ships
