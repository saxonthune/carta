...
Architecture considerations for comparing `.carta/` specifications against source code. This document will evolve as reconciliation moves from research (doc01.03.08.04) into implementation.
...
2. **Docs API is separate**: The Carta Docs API (doc01.03.06.01) manages workspace structure. Reconciliation tooling is a distinct concern that may *use* the Docs API but is not part of it.
...
- doc01.03.07 — Feature description (spec-code reconciliation)
- doc01.03.08.04 — Research session (two-source-of-truth model, data formats, script architecture)
