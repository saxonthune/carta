...
deps: [doc01.01.01.03, doc01.05.02]
---
...
The dual mandate (doc01.05.02) applies: structures must be useful for humans to author visually AND for AI to consume as structured data. The doc format (YAML in markdown) serves the AI. The canvas serves the human. Same data, two interfaces.
