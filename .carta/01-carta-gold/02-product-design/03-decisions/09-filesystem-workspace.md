...
The core thesis (doc01.03.04.01) asks: what is the maximum distance between code and its nearest artifact, such that AI can translate between the two reliably? The answer is a ladder of specification levels:
