...
deps: [doc01.03.08.01, doc01.01.05]
date: 2026-02-15
---
...
Each module exports pure functions that take data and return results. Hooks call these functions and apply results to the adapter. Tests exercise functions directly without React or Yjs. See doc01.03.08.01 for the corresponding integration tests.
