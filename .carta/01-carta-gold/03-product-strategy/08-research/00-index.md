...
- **Decisions already made** — those go in ADRs (doc01.03.08.02)
- **Feature specifications** — those go in doc01.03.02
...
- An ADR (doc01.03.08.02) once a decision crystallizes
- A feature spec (doc01.03.02) once the feature ships
