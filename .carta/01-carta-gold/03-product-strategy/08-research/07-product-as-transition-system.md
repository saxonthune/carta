...
This is the decreasing indirection thesis (doc01.03.04.02) applied to architecture: the product properties ARE the architecture decisions, viewed from a different angle. The indirection was never necessary — it existed because the product properties were never written down.
...
This connects directly to Simon's near-decomposability (doc01.03.04.02). Architecture is the discovery of **frequency boundaries** in the product:
...
- See also: doc01.03.04.01 (artifact-driven development), doc01.03.04.02 (theoretical foundations), doc01.03.08.03 (decomposition and composition theory).
