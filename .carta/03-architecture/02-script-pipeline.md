...
Architecture considerations for comparing `.carta/` specifications against source code. This document will evolve as reconciliation moves from research (doc01.08.06) into implementation.
...
- doc01.08.06 — Research session (two-source-of-truth model, data formats, script architecture)
