...
The presentation model is a pure transformation layer between domain state and React Flow rendering. It is not a React component or context — it is a stateless function that converts domain data into view-ready data. See doc02.08 for the full architecture.
