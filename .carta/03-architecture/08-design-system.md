...
Visual specifications for user-created content on the canvas — nodes, edges, organizer backgrounds, and LOD rendering.
...
Node cards are the primary visual elements on the canvas.
...
LOD bands control visual complexity at different zoom levels. The philosophy is "zoom reveals, it doesn't transform."
