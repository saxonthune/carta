...
deps: [doc01.02, doc01.04.01, doc01.07, doc02.08.09]
---
...
**Simon's nearly-decomposable systems** (doc01.08.05): Well-partitioned data are easier to manipulate and transform. One file per module means each piece can be diffed, updated, and reasoned about independently.
