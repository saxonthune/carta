...
```markdown
| doc04.06.01 | 01-cli-scripts.md | Carta Docs API | docs-api, workspace, tools |
```
...
```markdown
## Edit: CLAUDE.md
Source: doc04.06.01 §Operations

+| `carta punch` | Expand a leaf file into a directory |
```
...
```markdown
| doc03.01 | 01-workspace-scripts.md | ... | doc04.06.01 |
```

When editing doc04.06.01, the system knows to check doc03.01.
...
|-----|------|---------|------|------------|
| doc04.06.01 | 01-cli-scripts.md | Carta Docs API | docs-api, workspace | doc04.05 |
```
