...
```markdown
| doc01.03.08.01 | 02-state.md | Yjs Y.Doc state management | state, hooks, yjs |
```
...
```markdown
## Edit: CLAUDE.md
Source: doc01.03.08.01 §Hooks Layer
...
```markdown
| doc01.01.05 | 08-frontend.md | ... | doc01.03.08.01, doc01.03.08.05 |
```

When editing doc01.03.08.01, the system knows to check doc01.01.05.
...
|-----|------|---------|------|------------|
| doc01.03.08.01 | 02-state.md | Yjs state, hooks, adapters | state, hooks | doc01.03.08.01 |
```
