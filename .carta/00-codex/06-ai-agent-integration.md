...
MCP tools are the *only* interface for programmatic canvas mutation. File-level writes to canvas JSON are not supported — always use the MCP tools. See doc01.03.08.03 for the full tool reference.
