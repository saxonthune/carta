...
```markdown
| doc01.03.02 | 02-state.md | Yjs Y.Doc state management | state, hooks, yjs |
```
...
```markdown
## Edit: CLAUDE.md
Source: doc01.03.02 §Hooks Layer
...
```markdown
| doc02.04.03 | 08-frontend.md | ... | doc01.03.02, doc01.03.07 |
```

When editing doc01.03.02, the system knows to check doc02.04.03.
...
|-----|------|---------|------|------------|
| doc01.03.02 | 02-state.md | Yjs state, hooks, adapters | state, hooks | doc01.03.01 |
```
