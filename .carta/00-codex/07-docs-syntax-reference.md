...
doc01.03.08.03     → 01-product-strategy/08-research/03-wagon-aware-layout-architecture.md
doc01.02.03.01     → 02-product-design/08-decisions/01-yjs-state.md
```
...
```
doc01.02.03#sec02      → file doc01.02.03, section 02
doc01.02.03#sec01.02   → file doc01.02.03, section 01, subsection 02
```
...
|-----|------|---------|------|------|------|
| doc01.03.02 | `02-principles.md` | Design principles | principles, design | doc01.03.01 | doc01.02.05 |
```
