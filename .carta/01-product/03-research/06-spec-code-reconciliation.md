...
deps: [doc01.01.02, doc01.01.04.01, doc01.02.07, doc02.06.09]
---
...
**Simon's nearly-decomposable systems** (doc01.03.05): Well-partitioned data are easier to manipulate and transform. One file per module means each piece can be diffed, updated, and reasoned about independently.
