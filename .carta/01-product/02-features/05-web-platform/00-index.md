...
deps: [doc01.02.04, doc01.02.01, doc01.01.02]
---
...
Both flavors operate on the same workspace and the same spec files. Users can switch between them freely within a session. See doc01.02.05.01 and doc01.02.05.02 for details.
...
- Make implicit judgments about how specs should be arranged (see doc01.01.02, "Spec Agnosticism")
...
See doc02.05 for web platform architecture details.
