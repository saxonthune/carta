...
Additional shape variants (`circle`, `diamond`, `document`, `stadium`, `parallelogram`) were added to support BPMN, ISO 5807 flowcharts, and other notation-specific rendering (doc04.01). These follow the same architecture: schema-driven nodeShape dispatch to separate components.
...
### vs. Rough-to-Refined (doc01.04.08)
