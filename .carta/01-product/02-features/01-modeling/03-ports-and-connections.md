...
Port schemas are user-editable. New port schemas are created via the Metamap connection modal (doc01.02.01.05) or the schema creation wizard (doc01.02.01.06).
