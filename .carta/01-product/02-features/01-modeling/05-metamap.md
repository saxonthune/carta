...
- **Create schema**: Right-click context menu to create a new construct schema (opens wizard, doc01.02.01.06)
...
The Map (doc01.02.01.01) shows instances. The Metamap shows types. Changes in the Metamap (adding ports to a schema, creating new schemas) immediately affect what's available in the Map. The two views are toggled via a view switcher on the canvas.
