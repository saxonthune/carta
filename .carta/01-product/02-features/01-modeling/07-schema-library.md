...
- **Schema Package** (`SchemaPackage`): The unit of bundling and library portability. Contains schemas, in-package port schemas, and optional visual groups. See doc01.01.03, doc02.06.
