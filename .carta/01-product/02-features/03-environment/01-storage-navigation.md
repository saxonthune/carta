...
Storage navigation is minimal. The first visit auto-creates a single document (doc01.02.03.05). The document browser is available but not surfaced prominently because local mode is designed for single-document use.
