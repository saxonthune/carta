...
This is the same architecture as the Software Architect (doc01.03.01) and Team Workspace (doc01.03.03) use cases, just single-user.

## Features Used

- doc01.02.01.01 (Canvas) — primary workspace
- doc01.02.01.02 (Constructs) — modeling components
- doc01.02.01.06 (Schema Editor) — custom types
- doc01.02.02.01 (Compilation) — AI-readable output
- doc01.02.02.02 (Import/Export) — backup and sharing (playground mode)
- doc01.02.03.03 (AI Assistant) — user-key chat (optional)
