...
- doc01.02.01.02 (Constructs) — modeling software components
- doc01.02.01.03 (Ports and Connections) — defining relationships
- doc01.02.01.06 (Schema Editor) — creating domain-specific construct types
- doc01.02.02.01 (Compilation) — producing AI-consumable output
- doc01.02.03.03 (AI Assistant) — sidebar chat, MCP tools
