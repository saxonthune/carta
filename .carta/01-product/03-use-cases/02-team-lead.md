...
- Non-technical team members connect to a shared workspace server (see doc01.03.03, Team Workspace)
...
- doc01.02.01.05 (Metamap) — visual schema management
- doc01.02.01.06 (Schema Editor) — creating standardized schemas
- doc01.02.01.07 (Schema Library) — package-based schema distribution
- doc01.02.03.02 (Collaboration) — real-time co-editing via shared server
