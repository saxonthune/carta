...
Higher-level workflows for designing and refactoring schemas in the Metamap view. These compose the atomic "Define a Schema" workflow (doc01.04.03) into creative schema design activities.
...
- **Features**: doc01.02.01.05 (Metamap), doc01.02.01.06 (Schema Editor)
- **Atomic workflows**: doc01.04.03
...
- **Features**: doc01.02.01.05 (Metamap), doc01.02.01.06 (Schema Editor)
- **Atomic workflows**: doc01.04.03, doc01.04.01
...
- **Features**: doc01.02.01.06 (Schema Editor), doc01.02.01.03 (Ports and Connections)
