...
Seeds are TypeScript-based starter content (see doc01.02.03.05). Available via the header menu, seeds create pre-configured documents demonstrating features:
...
- doc01.02.02.02 (Import and Export)
