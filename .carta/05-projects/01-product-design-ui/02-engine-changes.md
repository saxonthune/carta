...
deps: [doc03.07, doc02.06, doc05.01.01]
---

# Engine Changes

Changes needed in the canvas engine (doc03.07 — Canvas Engine) and presentation model (doc02.06 — Presentation Model) to support the product design structure editors.
