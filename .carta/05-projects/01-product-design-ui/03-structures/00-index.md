...
The structured product modeling types from doc01.08.10 (plus additions from this project), viewed as product design tools to build. Each structure gets a visual editor. Structures compose — an entity field references an enumeration, a state machine transition uses a decision table for guard logic.
...
1. **Enumerations** — flat list editor. Simplest structure. Referenced by entity fields and decision table columns. See doc05.01.03.01.
...
6. **Process flow** — ordered step list with branching, or flowchart. Click-edge-to-insert interaction. See doc05.01.03.02.
