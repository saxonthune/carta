...
**Simon's nearly-decomposable systems** (doc04.08.03): Well-partitioned data are easier to manipulate and transform. One file per module means each piece can be diffed, updated, and reasoned about independently.
