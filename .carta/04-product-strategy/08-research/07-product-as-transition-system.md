...
deps: [doc04.04.01, doc04.04.02, doc04.08.03]
---
...
This is the decreasing indirection thesis (doc04.04.02) applied to architecture: the product properties ARE the architecture decisions, viewed from a different angle. The indirection was never necessary — it existed because the product properties were never written down.
...
This connects directly to Simon's near-decomposability (doc04.04.02). Architecture is the discovery of **frequency boundaries** in the product:
...
- See also: doc04.04.01 (artifact-driven development), doc04.04.02 (theoretical foundations), doc04.08.03 (decomposition and composition theory).
