...
**Workspace**: A `.carta/` directory containing a project's specifications and documentation. Workspaces follow a standard directory structure (numbered titles) and are the canonical source of truth for a project's design. A workspace can be authored manually or via AI agents.
