...
deps: [doc03.04.01, doc03.04.02, doc03.08.03]
---
...
This is the decreasing indirection thesis (doc03.04.02) applied to architecture: the product properties ARE the architecture decisions, viewed from a different angle. The indirection was never necessary — it existed because the product properties were never written down.
...
This connects directly to Simon's near-decomposability (doc03.04.02). Architecture is the discovery of **frequency boundaries** in the product:
...
**Tools that fit:** YAML/JSON frontmatter on spec files (what Rhidoc already uses), extended with a controlled vocabulary for product properties. The controlled vocabulary is the key contribution — not a new language, but a shared set of terms that product people and architects both understand.
...
5. Which of the five framings (annotations, dimensions, constraints, flows, types) should Rhidoc prioritize? Are some more natural for different abstraction levels of the spec ladder?
...
- See also: doc03.04.01 (artifact-driven development), doc03.04.02 (theoretical foundations), doc03.08.03 (decomposition and composition theory).
