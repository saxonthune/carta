...
Design exploration records from AI-assisted development sessions. These capture research findings, design reasoning, and the "why behind the why" for features that emerge from modeling Rhidoc with Rhidoc.

## What belongs here

- **Design exercises** that explore "how would Rhidoc need to change to support X?"
...
- **Decisions already made** — those go in ADRs under product-design
- **Feature specifications** — those go in product-design
...
- An ADR once a decision crystallizes
- A feature spec once the feature ships
