...
| doc01.01 | Mission | doc | Core goal — spec-driven development tool | mission, principles |
| doc01.02 | Vision | doc | Rhidoc is the transmission mechanism between AI and SDLC — converting AI capability into software through structured specifications | vision, transmission, ai, sdlc, spec-driven |
| doc01.03 | Concept Glossary | doc | Core ideas behind Rhidoc — signals metaphysics, intention, interpretation vs transduction, drift, and living structure | glossary, concepts, theory, signals, transduction |
| doc01.04 | Workspace Glossary | doc | Canonical vocabulary for the .rhidoc/ workspace format — products, workspace, spec, shape | glossary, terms, workspace |
| doc01.05 | Primary Sources | group (3) | — | — |
