...
doc01.08.03     → 04-product-strategy/08-research/03-decomposition-and-composition-theory.md
```
...
deps: [doc01.01, doc03.01]            # optional: doc refs to check on change
...
|-----|------|---------|------|------|------|
| doc01.03 | `02-glossary.md` | Canonical vocabulary | glossary, terms | doc01.01 | — |
```
