---
title: Vision
summary: Rhidoc is the transmission mechanism between AI and SDLC — converting AI capability into software through structured specifications
...
**Rhidoc is the transmission mechanism between AI (the motor) and SDLC (the tool).** Human labor turns the machine; the output is software.
