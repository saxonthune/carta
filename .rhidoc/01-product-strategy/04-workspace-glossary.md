...
summary: Canonical vocabulary for the .rhidoc/ workspace format — products, workspace, spec, shape
tags: [glossary, terms, workspace]
deps: []
---

# Workspace Glossary

Canonical definitions for the `.rhidoc/` workspace-format terms used throughout Rhidoc. Use these terms consistently — don't invent synonyms.
