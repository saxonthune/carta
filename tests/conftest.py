"""Shared test helpers and fixtures for the rhidoc test suite."""
...
from rhidoc.workspace import MARKER
...
def _run_rhidoc(rhidoc_copy: Path, *args: str) -> types.SimpleNamespace:
    """Run the rhidoc CLI against a workspace root (in-process)."""
...
def run_cli(capsys, monkeypatch):
    """Invoke the rhidoc CLI in-process and return (exit_code, stdout, stderr)."""
...
@pytest.fixture
def rhidoc_fixture(tmp_path):
    """Build a synthetic .rhidoc/ workspace and return its root."""
