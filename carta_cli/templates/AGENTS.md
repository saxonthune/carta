# Working in this `{{dir_name}}/` workspace
...
`{{dir_name}}/` is a **Carta workspace**: numbered Markdown docs with stable
...
on PATH, or `python3 {{dir_name}}/carta.py` if the workspace was made portable.
